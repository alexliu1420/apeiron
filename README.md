...
Examines the assumption the entire series made without stating: that the intelligence it describes has an inside. It runs from a derivation of what consciousness is, through the grounding of self-modeling, to a lens for the working AI researcher that turns the inside-question into structural targets and falsifiable predictions for AI development — the corpus's most direct engineering work, drawn together under *What Follows for Research* below.
